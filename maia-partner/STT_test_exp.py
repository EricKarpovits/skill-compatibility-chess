...
def play(white, black,plystring):
    ...
    curgame['name']=curgame['white']['name']+'x'+curgame['black']['name']+"_5" 
    return curgame
...
def worker(partner1_name, partner2_name, partner1_weights, partner2_weights,i,q,bitstring):
    ...
    #maiay=agent("sfw", ["/your/directory/stockfish_13_linux_x64_avx2"],25) 
    ...
    maiaexp=agent('m11',["lc0" , "--temperature=0", "--weights=models/maia-1100.pb.gz","--backend-opts=gpu="+str((i+2)%4) ],1)
    #maiaexp=agent("sfw", ["/your/directory/sfdir/sf2/stockfish_13_linux_x64_avx2"],25) 
    partnery=agent(partner2_name,["lc0" , "--weights="+partner2_weights,"--backend-opts=gpu="+str((i+3)%4)],1500,expector=maiaexp)   
...
name_of_run="battle_results/"+"stt_exp"
