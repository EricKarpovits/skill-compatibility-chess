...
from ..proto.net_pb2 import NetworkFormat, Net as pb_Net, Format as pb_Format
...
class Net:
    def __init__(self,
                 ...
                 moves_left=NetworkFormat.MOVES_LEFT_V1):
        ...
        self.pb.format.weights_encoding = pb_Format.LINEAR16
    ...
    def set_input(self, input_format):
        ...
        if input_format == NetworkFormat.INPUT_112_WITH_CANONICALIZATION_V2 or input_format == NetworkFormat.INPUT_112_WITH_CANONICALIZATION_V2_ARMAGEDDON:
            self.pb.min_version.minor = LC0_MINOR_WITH_INPUT_TYPE_5
        elif input_format >= NetworkFormat.INPUT_112_WITH_CANONICALIZATION_HECTOPLIES:
        ...
        elif input_format != NetworkFormat.INPUT_CLASSICAL_112_PLANE:
    ...
    def parse_proto(self, filename):
        ...
        if self.pb.format.network_format.network == NetworkFormat.NETWORK_SE:
            ...
            self.set_movesleftformat(NetworkFormat.MOVES_LEFT_NONE)
        elif self.pb.format.network_format.network == NetworkFormat.NETWORK_CLASSICAL:
            self.set_networkformat(
                NetworkFormat.NETWORK_CLASSICAL_WITH_HEADFORMAT)
            self.set_valueformat(NetworkFormat.VALUE_CLASSICAL)
            self.set_policyformat(NetworkFormat.POLICY_CLASSICAL)
            self.set_movesleftformat(NetworkFormat.MOVES_LEFT_NONE)
    ...
    def fill_net_v2(self, all_weights):
        ...
        for name, weights in all_weights:
            ...
            if name == 'input/conv2d/kernel:0' and self.pb.format.network_format.input < NetworkFormat.INPUT_112_WITH_CANONICALIZATION_HECTOPLIES:
